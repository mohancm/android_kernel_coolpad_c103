...
/* < LAFITE-5519 lichuangchuang 20160321 begin */
#ifdef CONFIG_GET_HARDWARE_INFO
#include <asm/hardware_info.h>
#endif
/* LAFITE-5519 lichuangchuang 20160321 end > */
...
/*< LAFITE-293 chaofubang type c headset detection 20151228 begin */
...
void ptn5150_usb_audio_mode_set(bool mode)
{
	...
	if (mode) {
		...
		if (0x02 == (ptn5150_usb->status_4_reg & 0x03)) {
			...
			/*< LAFITE-1254 chaofubang 20160202 begin */
			...
			/* LAFITE-1254 chaofubang 20160202 end >*/
		} else {
		...
		/* LAFITE-1254 chaofubang 20160202 end >*/
		/* < LAFITE-1304 chaofubang 20160202 begin */
		/* LAFITE-1254 chaofubang 20160203 end >*/
	...
	/* < LAFITE-1559 chaofubang 20160217 begin */
	wcd_mbhc_mech_plug_detect();
	/* LAFITE-1559 chaofubang 20160217 end >*/
	/* LAFITE-1254 chaofubang 20160203 end >*/
	/* LAFITE-1304 chaofubang 20160202 end >*/
	/* < LAFITE-1965 chaofubang 201600311 begin */
...
/* LAFITE-293 chaofubang type c headset detection 20151228 end >*/
...
static irqreturn_t ptn5150_cc_eint_interrupt_handler(int irq, void *data)
{
	...
	/* < LAFITE-5216 chaofubang 20160318 begin */
	wake_lock(&ptn5150_usb->ptn5150_wake_lock);
	/* LAFITE-5216 chaofubang 20160318 end >*/
...
/*LAFITE-2011 guohongtao 20160218 end*/
	...
	/* < LAFITE-1304 chaofubang 20160223 begin */
	reg_val0 = 0x34;
	reg_val1 = 0x40;
	reg_val2 = 0x11;
	reg_val3 = 0x00;
	...
	/* LAFITE-1304 chaofubang 20160223 end >*/
