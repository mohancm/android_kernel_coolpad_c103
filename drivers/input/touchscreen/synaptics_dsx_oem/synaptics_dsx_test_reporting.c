...
/* < LAFITE-713 by pangle at 20160119 begin*/
#define CALIBRATION_DATA_SIZE 3624
/* LAFITE-713 by pangle at 20160119 end > */
...
/* < LAFITE-481 by pangle at 20160112 begin*/
/* < LAFITE-713 by pangle at 20160119 begin*/
...
/* LAFITE-713 by pangle at 20160119 end > */
/* LAFITE-481 by pangle at 20160112 end >*/
...
static int test_do_preparation(void)
{
	...
	/* < LAFITE-1880 modify by pangle at 20160220 beign */
	//struct f54_control_86 reg_86;
	struct synaptics_rmi4_data *rmi4_data = f54->rmi4_data;
	...
	*/
	/* LAFITE-1880 modify by pangle at 20160220 end > */
...
*/
	/* < LAFITE-2363 pangle 20160226 begin */
	if(!strcmp(f54->rmi4_data->rmi4_mod_info.product_id_string, "S332U"))
	{
		return snprintf(buf, PAGE_SIZE, "Invalid product id\n");
	}
	/* LAFITE-2363 pangle 20160226 end > */
...
/* LAFITE-713 by pangle at 20160119 end > */
/* < LAFITE-4609 by pangle at 20160311 begin*/
...
/* LAFITE-4609 by pangle at 20160311 end > */
/* < LAFITE-713 by pangle at 20160119 begin*/
		...
		struct device_attribute *attr, char *buf)
{
	...
	/* < LAFITE-2571 pangle at 20160225 begin */
	...
	/* LAFITE-2571 pangle at 20160225 end > */
	if(result)
	{
...
/* < LAFITE-2363 pangle 20160224 begin */
...
/* LAFITE-2363 pangle 20160224 end > */
