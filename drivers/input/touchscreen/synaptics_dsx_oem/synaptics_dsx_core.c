...
/*< LAFITE-279 by pangle at 20160104 begin */
/*
#define FB_READY_RESET
#define FB_READY_WAIT_MS 100
#define FB_READY_TIMEOUT_S 30
*/
/* LAFITE-279 by pangle at 20160104 end > */
#define RPT_TYPE (1 << 0)
		...
		struct synaptics_rmi4_fn *fhandler)
{
	...
	/* < LAFITE-1473 modify by pangle at 201600215 begin */
	input_sync(rmi4_data->input_dev);
	/* LAFITE-1473 modify by pangle at 201600215 end > */
	mutex_unlock(&(rmi4_data->rmi4_report_mutex));
		...
		struct synaptics_rmi4_fn *fhandler)
{
	...
	for (button = 0; button < f1a->valid_button_count; button++) {
		...
		/* < LAFITE-4625 by pangle at 20160312 begin */
		...
		/* LAFITE-4625 by pangle at 20160312 end > */
		dev_dbg(rmi4_data->pdev->dev.parent,
				"%s: Button %d (code %d) ->%d\n",
				__func__, button,
				f1a->button_map[button],
		...
		bool enable, bool attn_only)
{
	...
	if (enable) {
		/* < LAFITE-385 modify by pangle at 20160106 begin */
		if (rmi4_data->irq_enabled)
		{
			SYNAP_INFO("synaptics already in irq enable");
			return retval;
		}
		/* LAFITE-385 modify by pangle at 20160106 end > */
		...
		unsigned int intr_count)
{
	...
	/*< LAFITE-385 colse no use function by pangle at 20160106 begin*/
	...
	/* LAFITE-385 colse no use function by pangle at 20160106 end >*/
	retval = synaptics_rmi4_reg_read(rmi4_data,
...
static void synaptics_rmi4_rebuild_work(struct work_struct *work)
{
	...
	mutex_lock(&exp_data.mutex);
	SYNAP_INFO("Enter %s",__func__);   /*<LAFITE-385 add trace by pangle at 20160106>*/
		...
		bool rebuild)
{
	int retval;
	struct synaptics_rmi4_exp_fhandler *exp_fhandler;
	SYNAP_INFO("Enter %s rebuild:%d",__func__,rebuild);  /*<LAFITE-385 add trace by pangle at 20160106>*/
...
/*< LAFITE-1669 modify by pangle at 20160217 begin */
...
/* LAFITE-1669 modify by pangle at 20160217 end >*/

/* < LAFITE-681 by pangle at 20160127 begin */
/* < LAFITE-2777 by pangle at 20160303 begin */
/*delete pinctrl for lafite*/
#ifdef PINCTRL
...
static int synaptics_rmi4_probe(struct platform_device *pdev)
{
	...
	rmi4_data->suspend = false;
	rmi4_data->issuspended = false; /*<LAFITE-385 add by pangle for resume flow at 20160106>*/
	rmi4_data->irq_enabled = false;
	rmi4_data->fingers_on_2d = false;
...
#endif
	/* < LAFITE-4140 by pangle at 20160307 begin */
	/*< LAFITE-4095 by pangle at 20160305 begin */
	rmi4_data_truly = rmi4_data;
    is_tp_insert = true;
	/* LAFITE-4095 by pangle at 20160305 end > */
	/* LAFITE-4140 by pangle at 20160307 end > */
...
static int synaptics_rmi4_suspend(struct device *dev)
{
	...
	/* LAFITE-1669 modify by pangle at 20160217 end >*/
	/* < LAFITE-385 add by pangle for resume flow at 20160106 begin */
	/*< LAFITE-4179 by pangle at 20160309 begin */
	if (rmi4_data->stay_awake)
	{
	...
	/* LAFITE-4179 by pangle at 20160309 end > */
	/* LAFITE-385 add by pangle for resume flow at 20160106 end > */
	if (rmi4_data->enable_wakeup_gesture) {
		synaptics_rmi4_wakeup_gesture(rmi4_data, true);
		enable_irq_wake(rmi4_data->irq);
		goto exit;
...
exit:
	...
	rmi4_data->suspend = false;
	rmi4_data->issuspended = true;  /* < LAFITE-385 add by pangle for resume flow at 20160106 > */
	/* < LAFITE-4179 by pangle at 20160309 begin */
	tp_sleep_mode = false;
	/* LAFITE-4179 by pangle at 20160309 end > */
