...
static struct DRV2604L_platform_data  drv2604l_plat_data = {
	...
	.actuator = {
		.device_type = LRA,
/*LAFITE-1616:yuquan modified begin:reduce voltage*/
/*LAFITE-1616:guohongtao modified begin:reduce voltage*/
/*LAFITE-2487:shenxinyu modified begin:reduce voltage*/
/*LAFITE-5770:shenxinyu modified begin:increase voltage*/
		.rated_vol = 0x13,
/*LAFITE-5770:shenxinyu modified end:inctease voltage*/
/*LAFITE-2487:shenxinyu modified end:reduce voltage*/
/*LAFITE-1616:guohongtao modified end:reduce voltage*/
/*LAFITE-1616:yuquan modified end:reduce voltage*/
		.over_drive_vol = 0x87,
		.LRAFreq = 204,
	},
...
/*LAFITE-1572:yuquan  deleted begin:move calibration process to lk:*/
#if 0
...
#endif
/*LAFITE-1572:yuquan  deleted end:move calibration process to lk:*/
...
/*< LAFITE-281 guohongtao 20151224 end>*/
...
/*< LAFITE-3116 guohongtao 20160229 begin>*/
	if((pDrv2604ldata->device_id != DRV2604L)&&(pDrv2604ldata->device_id != DRV2604)){
/*< LAFITE-3116 guohongtao 20160229 end>*/
