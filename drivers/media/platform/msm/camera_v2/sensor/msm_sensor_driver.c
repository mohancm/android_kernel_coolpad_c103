...
#endif
/*End  added by yangyongfeng for camera sensor hardware_info (ql153) 20151222 */

/*add by jk for external pa hardware version start*/
#include <linux/bootreason.h>
/*add by jk for external pa hardware version end*/
